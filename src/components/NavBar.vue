...
// });
// const link = `${props.param == "" ? "/" : props.param }`;
// const link_gallery = `/gallery${props?.param??"" == "" ? "" : props.param }`;
// const link_contact = `/contact${props?.param??"" == "" ? "" : props.param }`;
</script>

<template>
	<div class="col-12 text-center py-2 px-3 mb-3 d-flex border">
